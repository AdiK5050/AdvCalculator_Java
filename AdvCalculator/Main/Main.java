package AdvCalculator.out.Main;

import java.util.Scanner;
import java.util.InputMismatchException;
import AdvCalculator.out.InputHandling.Input;
import AdvCalculator.out.oprFiles.Addition;
import AdvCalculator.out.oprFiles.Subtraction;
import AdvCalculator.out.oprFiles.Division;
import AdvCalculator.out.oprFiles.Multiplication;
